...
| Project Link  | Completion Date | Tools | Project Description |
| ------------- | ------------- | ------------- | ------------- |
| [🧠 Clinical Consciousness Status Analysis](https://github.com/redefiningvicky/Clinical-Consciousness-Status-Analysis) | January 2026  | Tableau, Microsoft Excel  | Tableau and Microsoft Excel were used to filter medical hierarchies, creating a direct link between neurological injury and critical care requirements.  |
